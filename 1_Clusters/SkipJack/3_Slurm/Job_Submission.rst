...
The SkipJack Cluster uses **Slurm (Simple Linux Universal Resource Manager)** to manage job submission, scheduling, and resource allocation. It is a widely adopted, open-source workload manager used by many HPC centers.
...
.. code-block:: console
   ...
   **TODO**: Add command to display jobs (sqme or squeue variant)
