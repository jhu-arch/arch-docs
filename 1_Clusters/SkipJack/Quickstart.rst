...
Item                             Notes
===============================  =======================================
JHED *and* SkipJack account      Request one on `Coldfront <TODO: Add Coldfront URL>`__
...
*First time?* Type **yes** at the host-key prompt, then your SkipJack password.
